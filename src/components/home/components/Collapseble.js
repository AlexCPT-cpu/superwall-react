      ...
      <div className="  shadow-[0px 4px 24px rgba(0, 0, 0, 0.25)] rounded-[40px] ">
        ...
        <div>
          <Collapsible open={open}>
            <div className="relative pl-0 md:pl-1.5 md:mt-[8px] sm:mt-0 w-[100.1%] rounded-b-[-30px]  h-full mt-[5px] ">
              
            <div className="flex flex-col lg:flex-row lg:justify-between items-start  borderlinear   lg:items-center border-2  ">
                {firstitems ? (
                  <div className="w-[95%] md:w-[70%] mx-5 my-10">
                    <p className="text-lg md:text-2xl pl-5 font-semibold">
                      Super Pass = 1 Free GEB Mint
                    </p>
                    <p className="text-[14px] md:text-[22px] pl-5 font-medium mt-2">
                    ...
                    <p className="text-[12px] md:text-sm  pl-5 font-normal hidden md:block">
                    ...
                    <div className="w-[90%] flex justify-between pl-5 items-center md:hidden mt-2">
                      <div className="">
                        <p className="text-[12px] md:text-sm pl-5 font-normal">
                          *2nd snapshot date and time TBD
                        </p>
                        <p className="text-[12px] md:text-sm pl-5 font-normal">
                          **Current Holder Screenshot will be taken and used to
                  ...
                  <div className="w-[95%] md:w-[70%] mx-2 my-5 lg:mx-5 lg:my-10">
                    ...
                    <p className="text-[10px] md:text-[22px] pl-5 font-medium mt-2">
                      Free Mint Terms & Conditions:{" "}
                    </p>
                    <p className="text-[10px] md:text-lg pl-5 font-medium flex ">
                      <img
                        className="mr-2 w-[25px] h-[25px]"
                        src="/assets/images/neoncheck.png"
                        alt=""
                    ...
                    <p className="text-[10px] md:text-sm pl-5 font-normal hidden md:block">
                      *Current Holder Screenshot will be taken and used to
                      identify the holders who will be eligible for the 50%
                      discount{" "}
                    </p>
                    ...
                    <div className="w-[90%] flex justify-between  items-center md:hidden mt-2">
                      <div>
                        {" "}
                        <p className="text-[10px] md:text-sm pl-5 font-normal">
                          *Current Holder Screenshot will be taken and used to
                          identify the holders who will be eligible for the 50%
                          discount{" "}
                        </p>
